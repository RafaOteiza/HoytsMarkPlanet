...
public class EliminarPelicula extends javax.swing.JInternalFrame {
    ...
    try {
        ...
        if (row == -1) {
            JOptionPane.showMessageDialog(null, "Debe seleccionar una película para eliminar");
            return;
        }
        ...
        if (confirmation == JOptionPane.YES_OPTION) {
            int movElim = Integer.valueOf(listaMovies.getModel().getValueAt(row, 0).toString());
        ...
        JOptionPane.showMessageDialog(null, "Ocurrió un error al intentar eliminar la película");
    }
